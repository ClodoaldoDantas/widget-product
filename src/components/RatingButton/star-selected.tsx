export function StarSelected() {
  return (
    <svg
      ...
      fill="none"
    >
      <g clipPath="url(#clip0_807_3)">
        <g filter="url(#filter0_d_807_3)">
          <path
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_807_3"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_807_3"
            result="shape"
          />
        </filter>
        <linearGradient
          id="paint0_linear_807_3"
          x1="2"
          y1="12"
          x2="30"
          y2="21.5"
        ...
        >
          ...
          <stop offset="1" stopColor="#D5983E" />
        </linearGradient>
